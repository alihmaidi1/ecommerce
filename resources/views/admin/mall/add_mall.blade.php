...
<form  class="col-sm-12 col-md-6" enctype="multipart/form-data" method="POST" action="{{ route("save_mall") }}">
    @csrf
...
<br/>
    ...
    <br/>
    <div class="m-auto d-flex justify-content-center"><button class="btn btn-primary w-75   ">{{ __("messages.Create mall") }}</button></div>
</form>
</div>
  </div>
