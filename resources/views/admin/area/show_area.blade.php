    ...
    <div class="alert alert-danger d-flex justify-content-center">{{ session()->get("error") }}</div>
        ...
        <table class="table text-center table-hover">
            <thead class="table-dark">
                ...
                <th style="min-width:220px;vertical-align:middle">{{ __("messages.Name") }}</th>
                <th style="min-width:180px;vertical-align:middle">{{ __("messages.city") }}</th>
            ...
            <tbody id="tbody_area">
         @foreach($admin2=App\Models\area::paginate(8) as $user)
        ...
        <a href="{{ route('add_area') }}" class="btn btn-primary"><i class="fas fa-plus"></i>{{ __("messages.Add Area") }}</a>
        <br/>
        <br/>
<div id="pagin_area" class="d-flex justify-content-center">{{ $admin2->links() }}</div>
