...
<div class="login-box">
  ...
  <div class="card "  >
    <div class="card-body login-card-body" style="background: #000">
      <p class="login-box-msg text-white">{{ __("messages.Sign in to start your session") }}</p>
      ...
      <form  method="post">
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" placeholder="{{ __("messages.Email") }}">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block">{{ __("messages.Sign In") }}</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
