...
<form  class="col-sm-12 col-md-6  " method="POST" action="{{ route("save_size") }}" enctype="multipart/form-data">
    @csrf
    ...
    <br/>
    <div class="m-auto d-flex justify-content-center"><button class="btn btn-primary w-75">{{ __("messages.Create size") }}</button></div>
</form>
</div>
  </div>
